# 1 "../../tec_control/tec_comm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../tec_control/tec_comm.c" 2
# 12 "../../tec_control/tec_comm.c"
...
# 21 "../../tec_control/tec_comm.c" 2
# 1 "../../tec_control/tec_comm.h" 1
# 18 "../../tec_control/tec_comm.h"
...
# 19 "../../tec_control/tec_comm.h" 2
# 35 "../../tec_control/tec_comm.h"
void tec_save_ctl_temperature_value(uint16_t temp);
# 49 "../../tec_control/tec_comm.h"
void tec_config_init();
# 63 "../../tec_control/tec_comm.h"
void tec_process();
# 78 "../../tec_control/tec_comm.h"
void tec_pid_calc_auto();
# 93 "../../tec_control/tec_comm.h"
void tec_start_auto_adjust();
# 108 "../../tec_control/tec_comm.h"
void tec_set_default_mini_status();
# 123 "../../tec_control/tec_comm.h"
void tec_set_ctrl_temperature_obj(float temp);
# 22 "../../tec_control/tec_comm.c" 2
...
# 27 "../../tec_control/tec_comm.c" 2
# 1 "../../tec_control/tec_driver.h" 1
# 28 "../../tec_control/tec_driver.h"
void tec_release_limit_refresh();
# 42 "../../tec_control/tec_driver.h"
void tec_set_ctl_voltage(float voltage);
# 56 "../../tec_control/tec_driver.h"
void tec_get_xtec_voltage(float *voltage);
# 72 "../../tec_control/tec_driver.h"
void tec_device_init();
# 28 "../../tec_control/tec_comm.c" 2
# 37 "../../tec_control/tec_comm.c"
volatile TEC_GLOBAL_VARS_PARAM g_tec_vars_param;
# 53 "../../tec_control/tec_comm.c"
void tec_global_vars_init()
{
 ...
 g_tec_vars_param.g_ctl_voltage_set = (1.25);
# 81 "../../tec_control/tec_comm.c"
 g_tec_vars_param.g_tec_calc_argum_auto_flag = SET;
# 90 "../../tec_control/tec_comm.c"
 g_tec_vars_param.g_tec_ctrl_temperautre_obj = 5000;

}
# 107 "../../tec_control/tec_comm.c"
...
# 140 "../../tec_control/tec_comm.c"
void tec_calc_auto_rth_temp(void)
{
 float rth_temp = 0.0;
 float tmp = 0.0;
 uint16_t rth_temp_value = 0;
 uint32_t int_tmp = 0;

 get_tec_therm_temperature(&rth_temp);


 rth_temp_value = (rth_temp + 40)* 100;


 if(rth_temp_value > (g_tec_vars_param.g_tec_ctrl_temperautre_obj + 100 + 40 * 100))
 {

  tmp = (rth_temp_value - g_tec_vars_param.g_tec_ctrl_temperautre_obj - 40 * 100);



  int_tmp = (tmp * 100/ 100 * 0.01);
  if(int_tmp > 10)
  {
   g_tec_vars_param.g_ctl_voltage_set -= 0.1;
  }
  else
  {
   g_tec_vars_param.g_ctl_voltage_set -= tmp / 100 * 0.01;
  }
 }
 else if(rth_temp_value < (g_tec_vars_param.g_tec_ctrl_temperautre_obj + 100 + 40 * 100))
 {

  tmp = (g_tec_vars_param.g_tec_ctrl_temperautre_obj - rth_temp_value + 40 * 100);
 ...
 if(g_tec_vars_param.g_ctl_voltage_set > 2)
 {
  g_tec_vars_param.g_ctl_voltage_set = 2;
 }
 else if(g_tec_vars_param.g_ctl_voltage_set < 0.45)
 {
  g_tec_vars_param.g_ctl_voltage_set = 0.45;
 }

 tec_set_ctl_voltage(g_tec_vars_param.g_ctl_voltage_set);

}
# 214 "../../tec_control/tec_comm.c"
void tec_save_ctl_temperature_value(uint16_t temp)
{
 if(temp < 4000)
 {
...
# 249 "../../tec_control/tec_comm.c"
void tec_process()
{
# 271 "../../tec_control/tec_comm.c"
 if(SET == g_tec_vars_param.g_tec_calc_argum_auto_flag)
 {

  if(g_mcu_vars_param.g_tec_pid_calc_ms_task > 1000) {
...
# 318 "../../tec_control/tec_comm.c"
void tec_start_auto_adjust()
{
 g_tec_vars_param.g_tec_calc_argum_auto_flag = SET;
}
# 337 "../../tec_control/tec_comm.c"
void tec_set_default_mini_status()
{
 g_tec_vars_param.g_tec_calc_argum_auto_flag = 1;
 g_tec_vars_param.g_tec_proc_flag = SET;
    sgm41296_vtec_dac_ctl_set(1.25);
}
# 356 "../../tec_control/tec_comm.c"
void tec_set_ctrl_temperature_obj(float temp)
{
 uint16_t value = temp * 100;
