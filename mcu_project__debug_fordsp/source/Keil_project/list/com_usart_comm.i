# 1 "../../mcu/com_usart_comm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../mcu/com_usart_comm.c" 2
# 50 "../../mcu/com_usart_comm.c"
...
void com_usart_gpio_config(void)
{
 ...
 gpio_af_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) & ((uint32_t)(1) << 0)), ((uint32_t)((uint32_t)0x01U<<(9))));


 gpio_af_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) & ((uint32_t)(1) << 0)), ((uint32_t)((uint32_t)0x01U<<(10))));


 gpio_mode_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(2) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), ((uint32_t)((uint32_t)0x01U<<(9))));
 gpio_output_options_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), ((uint8_t)(0x00U)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)),
  ((uint32_t)((uint32_t)0x01U<<(9))));


 gpio_mode_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(2) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), ((uint32_t)((uint32_t)0x01U<<(10))));
 gpio_output_options_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), ((uint8_t)(0x00U)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)),
...
void com_usart_init(void)
{
    ...
    usart_deinit(((((uint32_t)0x40000000U) + 0x00004400U) + 0x0000F400U));
    usart_word_length_set(((((uint32_t)0x40000000U) + 0x00004400U) + 0x0000F400U), (((uint32_t)((uint32_t)0x01U<<(12))) & ((uint32_t)(0) << 12)));
    usart_stop_bit_set(((((uint32_t)0x40000000U) + 0x00004400U) + 0x0000F400U), (((0xFFFFFFFFUL << (12)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(13)))) & ((uint32_t)(0) << 12)));
    usart_parity_config(((((uint32_t)0x40000000U) + 0x00004400U) + 0x0000F400U), (((0xFFFFFFFFUL << (9)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(10)))) & ((uint32_t)(0) << 9)));
    usart_baudrate_set(((((uint32_t)0x40000000U) + 0x00004400U) + 0x0000F400U), 115200U);
    usart_receive_config(((((uint32_t)0x40000000U) + 0x00004400U) + 0x0000F400U), (((uint32_t)((uint32_t)0x01U<<(2))) & ((uint32_t)(1) << 2)));
    usart_transmit_config(((((uint32_t)0x40000000U) + 0x00004400U) + 0x0000F400U), (((uint32_t)((uint32_t)0x01U<<(3))) & ((uint32_t)(1) << 3)));

    usart_enable(((((uint32_t)0x40000000U) + 0x00004400U) + 0x0000F400U));
 usart_interrupt_enable(((((uint32_t)0x40000000U) + 0x00004400U) + 0x0000F400U), USART_INT_TBE);
