# 1 "../../mcu/adc_sample_comm/adc_sample_comm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../mcu/adc_sample_comm/adc_sample_comm.c" 2
# 12 "../../mcu/adc_sample_comm/adc_sample_comm.c"
...
# 13 "../../mcu/adc_sample_comm/adc_sample_comm.c" 2
...
# 14 "../../mcu/adc_sample_comm/adc_sample_comm.c" 2
# 1 "../../mcu/GDE501_fireware\\systick.h" 1
# 39 "../../mcu/GDE501_fireware\\systick.h"
...
# 40 "../../mcu/GDE501_fireware\\systick.h" 2
...
# 15 "../../mcu/adc_sample_comm/adc_sample_comm.c" 2
# 1 "../../mcu/adc_sample_comm/adc_sample_comm.h" 1
# 16 "../../mcu/adc_sample_comm/adc_sample_comm.h"
...
# 17 "../../mcu/adc_sample_comm/adc_sample_comm.h" 2
...
# 16 "../../mcu/adc_sample_comm/adc_sample_comm.c" 2
# 1 "../../mcu/adc_sample_comm/adc_sample_driver.h" 1
# 34 "../../mcu/adc_sample_comm/adc_sample_driver.h"
void adc_sample_gpio_init();
# 17 "../../mcu/adc_sample_comm/adc_sample_comm.c" 2
...
# 21 "../../mcu/adc_sample_comm/adc_sample_comm.c" 2
...
volatile uint16_t adc_dma_sample_value[ADC_REGULAR_RANK_SIZE];
# 45 "../../mcu/adc_sample_comm/adc_sample_comm.c"
uint16_t adc_sample_dma_regular_data_channel(uint8_t ch)
{
...
# 97 "../../mcu/adc_sample_comm/adc_sample_comm.c"
uint16_t adc_regular_channel_sample(uint8_t rank,uint8_t channel)
{
 uint32_t run_us = 0;
 uint8_t cyl = 0;
    ...
    adc_regular_channel_config(rank, channel, (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(2)))) & ((uint32_t)(5) << 0)));

    adc_software_trigger_enable(((uint8_t)0x01U));



   run_us = 500;
 cyl = 0;
 (run_us) *= 72; while((run_us) > 1) { if(!(!adc_flag_get(((uint32_t)((uint32_t)0x01U<<(2)))))) { cyl = 0; break; } run_us--; } if(1 == run_us) { cyl = 1; };


    adc_flag_clear(((uint32_t)((uint32_t)0x01U<<(1))));


    return (adc_regular_data_read());
}
# 135 "../../mcu/adc_sample_comm/adc_sample_comm.c"
void adc_dma_config_init()
{

    dma_parameter_struct dma_data_parameter;

 for(uint32_t i = 0; i < ADC_REGULAR_RANK_SIZE;i++)
 {
  adc_dma_sample_value[i] &= 0;
 }
# 152 "../../mcu/adc_sample_comm/adc_sample_comm.c"
    dma_deinit(DMA_CH0);


    dma_data_parameter.periph_addr = (uint32_t)(&(*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00002400U) + 0x4CU)));
    dma_data_parameter.periph_inc = ((uint8_t)0x00U);
    dma_data_parameter.memory_addr = (uint32_t)(&adc_dma_sample_value);
    dma_data_parameter.memory_inc = ((uint8_t)0x01U);
    dma_data_parameter.periph_width = (((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(9)))) & ((1U) << 8));
    dma_data_parameter.memory_width = (((0xFFFFFFFFUL << (10)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(11)))) & ((1U) << 10));
    dma_data_parameter.direction = ((uint8_t)0x00U);


    dma_data_parameter.number = ADC_REGULAR_RANK_SIZE;
    dma_data_parameter.priority = (((0xFFFFFFFFUL << (12)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(13)))) & ((2U) << 12));
...
# 250 "../../mcu/adc_sample_comm/adc_sample_comm.c"
void adc_sample_function_init()
{

 adc_special_function_config(((uint32_t)((uint32_t)0x01U<<(1))), ENABLE);


 adc_special_function_config(((uint32_t)((uint32_t)0x01U<<(8))), ENABLE);


 adc_external_trigger_source_config(((uint8_t)0x01U),
  (((0xFFFFFFFFUL << (17)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(19)))) & ((uint32_t)(7) << 17)));
 adc_external_trigger_config(((uint8_t)0x01U), ENABLE);


 adc_external_trigger_source_config(((uint8_t)0x02U),
 (((0xFFFFFFFFUL << (12)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(14)))) & ((uint32_t)(7) << 12)));
 adc_external_trigger_config(((uint8_t)0x02U), ENABLE);


 adc_data_alignment_config(((uint32_t)0x00000000U));





 adc_channel_length_config(((uint8_t)0x01U), ADC_REGULAR_RANK_SIZE);
 adc_regular_channel_config(TEC_RTH_TEMP_ADC_RANK_ID, ((uint8_t)0x0BU), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(2)))) & ((uint32_t)(5) << 0)));
 adc_regular_channel_config(XTEC_OUT_ADC_RANK_ID, ((uint8_t)0x0AU), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(2)))) & ((uint32_t)(5) << 0)));
 adc_regular_channel_config(CASE_TEMP_ADC_RANK_ID, ((uint8_t)0x04U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(2)))) & ((uint32_t)(5) << 0)));




 adc_channel_length_config(((uint8_t)0x02U), ADC_INSERT_RANK_SIZE);
 adc_inserted_channel_config(RXPW_RSSI_ADC_50G_RANK_INSERT_ID, ((uint8_t)0x0CU), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(2)))) & ((uint32_t)(5) << 0)));
 adc_inserted_channel_config(RXPW_RSSI_ADC_10G_RANK_INSERT_ID, ((uint8_t)0x05U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(2)))) & ((uint32_t)(5) << 0)));
 adc_inserted_channel_config(RXPW_RSSI_ADC_1G_RANK_INSERT_ID, ((uint8_t)0x00U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(2)))) & ((uint32_t)(5) << 0)));
 ...
 adc_software_trigger_enable(((uint8_t)0x01U));
 adc_software_trigger_enable(((uint8_t)0x02U));



}
# 323 "../../mcu/adc_sample_comm/adc_sample_comm.c"
uint16_t get_adc_inserted_channel_sample(uint8_t rank,uint8_t channel)
{
 uint32_t run_us = 0;
 uint8_t cyl = 0;
    ...
    adc_inserted_channel_config(rank, channel, (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(2)))) & ((uint32_t)(5) << 0)));
 ...
 (run_us) *= 72; while((run_us) > 1) { if(!(!adc_flag_get(((uint32_t)((uint32_t)0x01U<<(2)))))) { cyl = 0; break; } run_us--; } if(1 == run_us) { cyl = 1; };
    ...
    adc_flag_clear(((uint32_t)((uint32_t)0x01U<<(2))));
