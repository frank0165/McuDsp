# 1 "../../ddm_process/ddm_i2c_interface.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../ddm_process/ddm_i2c_interface.c" 2
...
# 5 "../../ddm_process/ddm_i2c_interface.h" 2
...
# 6 "../../ddm_process/ddm_i2c_interface.h" 2
...
# 7 "../../ddm_process/ddm_i2c_interface.h" 2
...
# 8 "../../ddm_process/ddm_i2c_interface.h" 2
...
# 9 "../../ddm_process/ddm_i2c_interface.h" 2
...
# 17 "../../ddm_process/ddm_10g_config\\ddm_10g_config_interface.h"
# 1 "../../include\\user_config.h" 1
# 18 "../../ddm_process/ddm_10g_config\\ddm_10g_config_interface.h" 2
...
# 15 "../../ddm_process/ddm_i2c_interface.h" 2
...
# 16 "../../ddm_process/ddm_i2c_interface.h" 2
...
void ddm_i2c_50g_monitor_reg_read(uint8_t regaddr,uint8_t *pbuff,uint32_t
    bufflen);
# 3 "../../ddm_process/ddm_i2c_interface.c" 2
# 17 "../../ddm_process/ddm_i2c_interface.c"
void apc_target_voltage_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 float vol_real = 0.0;
 uint16_t vol_value = 0;
 if(0 == pbuff || bufflen < 5)
 {
  return;
 }
...
# 125 "../../ddm_process/ddm_i2c_interface.c"
void apd_i2c_vcc_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 uint8_t *ptr = pbuff + 1;
 uint16_t apd_value;
 apd_value = get_u16((ptr + 1));
 float apd_vcc = apd_value * 0.1;
...
# 187 "../../ddm_process/ddm_i2c_interface.c"
void soa_i2c_ild_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 uint8_t *ptr = pbuff + 1;
 uint16_t ild_value;
...
# 227 "../../ddm_process/ddm_i2c_interface.c"
void vea_i2c_vcc_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 uint8_t *ptr = pbuff + 1;
 uint16_t vea_value;
...
# 277 "../../ddm_process/ddm_i2c_interface.c"
void ibias_i2c_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 uint8_t *ptr = pbuff + 1;
...
# 343 "../../ddm_process/ddm_i2c_interface.c"
void imod_i2c_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 uint8_t *ptr = pbuff + 1;
 uint16_t imod_value;
...
# 410 "../../ddm_process/ddm_i2c_interface.c"
void swing_i2c_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 uint8_t *ptr = pbuff + 1;
 uint16_t swing_value;
...
# 473 "../../ddm_process/ddm_i2c_interface.c"
void rx_eq_i2c_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 uint8_t *ptr = pbuff + 1;
 uint16_t eq_value;
...
# 525 "../../ddm_process/ddm_i2c_interface.c"
void cpa_i2c_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 uint8_t *ptr = pbuff + 1;
 uint16_t cpa_value;
...
# 589 "../../ddm_process/ddm_i2c_interface.c"
void tx_deemph_i2c_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 uint8_t *ptr = pbuff + 1;
 uint16_t tx_deemph_value;
...
# 641 "../../ddm_process/ddm_i2c_interface.c"
void rx_deemph_i2c_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 uint8_t *ptr = pbuff + 1;
 uint16_t rx_deemph_value;
...
# 691 "../../ddm_process/ddm_i2c_interface.c"
void rx_los_threshold_i2c_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 uint8_t *ptr = pbuff + 1;
 uint16_t rx_los_threshold_value;
...
# 759 "../../ddm_process/ddm_i2c_interface.c"
void rx_los_hyst_i2c_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 uint8_t *ptr = pbuff + 1;
 uint16_t rx_los_hyst_value;
...
# 820 "../../ddm_process/ddm_i2c_interface.c"
void cmd_command_map_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 uint32_t type = 0;
 if(0 == pbuff || bufflen < 2)
 {
  return;
 }
...
# 926 "../../ddm_process/ddm_i2c_interface.c"
void ddm_i2c_switch_auto_process_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 uint8_t reg = 0;


 if(0 == pbuff || bufflen < 3)
 {
  return;
 }
...
# 974 "../../ddm_process/ddm_i2c_interface.c"
}
# 992 "../../ddm_process/ddm_i2c_interface.c"
void import_binary_file_data_to_mcu_flash(uint8_t *p_buff, uint32_t buff_len) {
    uint32_t write_len;
    ErrStatus ret;

    if (p_buff == 0 || buff_len < 2) {
        return;
    }
   ...
   g_mcu_vars_param.g_update_process_flag = SET;
        ...
        case 0x01:
            ...
            if ((g_update_mem_idx + write_len) > 1024) {
                comm_update_write_to_flash((((0x0807F000U - 0x1400) - 0x19000) - 0x400));
                g_update_mem_idx = 0;
            }
...
# 1062 "../../ddm_process/ddm_i2c_interface.c"
