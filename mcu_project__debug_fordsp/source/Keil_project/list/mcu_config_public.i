# 1 "../../mcu/mcu_config_public.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../mcu/mcu_config_public.c" 2
...
# 5 "../../mcu/mcu_config_public.c" 2
# 1 "../../mcu/mcu_config_public.h" 1
# 15 "../../mcu/mcu_config_public.h"
...
# 6 "../../mcu/mcu_config_public.c" 2
# 33 "../../mcu/mcu_config_public.c"
void rcu_config_init(void)
{
