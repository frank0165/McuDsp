# 1 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c" 2
# 36 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
...
# 37 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c" 2
...
void adc_idma_mode_enable(void)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00002400U) + 0x88U)) |= (uint32_t)(((uint32_t)((uint32_t)0x01U<<(1))));
}
...
# 175 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_discontinuous_mode_config(uint8_t channel_group, uint8_t length)
{
...
# 206 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_special_function_config(uint32_t function, ControlStatus newvalue)
{
    if(newvalue){
...
# 246 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_data_alignment_config(uint32_t data_alignment)
{
...
# 267 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_channel_length_config(uint8_t channel_group, uint32_t length)
{
    switch(channel_group){
    case ((uint8_t)0x01U):
...
# 304 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_regular_channel_config(uint8_t rank, uint8_t channel, uint32_t sample_time)
{
    uint32_t rsq,sampt;
...
# 362 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_inserted_channel_config(uint8_t rank, uint8_t channel, uint32_t sample_time)
{
...
# 402 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_inserted_channel_offset_config(uint8_t inserted_channel, uint16_t offset)
{
    uint8_t inserted_length;
    uint32_t num = 0U;
...
void adc_inserted_channel_repeat_time_config(uint8_t time)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00002400U) + 0x88U)) &= (~(uint32_t)((0xFFFFFFFFUL << (2)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))));
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00002400U) + 0x88U)) |= (uint32_t)((uint32_t)time << 2U);
}
# 440 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_external_trigger_config(uint8_t channel_group, ControlStatus newvalue)
{
    if(newvalue){
...
# 496 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_external_trigger_source_config(uint8_t channel_group, uint32_t external_trigger_source)
{
    switch(channel_group){
    case ((uint8_t)0x01U):

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00002400U) + 0x08U)) &= ~((uint32_t)(((uint32_t)((uint32_t)0x01U<<(26))) | ((0xFFFFFFFFUL << (17)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(19))))));
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00002400U) + 0x08U)) |= (uint32_t)external_trigger_source;
        break;
    case ((uint8_t)0x02U):

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00002400U) + 0x08U)) &= ~((uint32_t)(((uint32_t)((uint32_t)0x01U<<(25))) | ((0xFFFFFFFFUL << (12)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(14))))));
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00002400U) + 0x08U)) |= (uint32_t)external_trigger_source;
        break;
    default:
        break;
...
# 523 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
uint32_t adc_temp_tt = 0;
void adc_software_trigger_enable(uint8_t channel_group)
{
...
# 559 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
uint16_t adc_inserted_data_read(uint8_t inserted_channel)
{
    uint32_t idata;
...
# 591 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_watchdog_single_channel_enable(uint8_t channel)
{
...
# 609 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_watchdog_group_channel_enable(uint8_t channel_group)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00002400U) + 0x04U)) &= (uint32_t)~(((uint32_t)((uint32_t)0x01U<<(23))) | ((uint32_t)((uint32_t)0x01U<<(22))) | ((uint32_t)((uint32_t)0x01U<<(9))));
...
# 647 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_watchdog_threshold_config(uint16_t low_threshold, uint16_t high_threshold)
{
...
# 664 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_resolution_config(uint32_t resolution)
{
...
# 700 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_oversample_mode_config(uint8_t mode, uint16_t shift, uint8_t ratio)
{
...
# 748 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
FlagStatus adc_flag_get(uint32_t flag)
{
...
# 770 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_flag_clear(uint32_t flag)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00002400U) + 0x00U)) &= ~((uint32_t)flag);
}
# 785 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_interrupt_enable(uint32_t interrupt)
{
...
# 813 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_interrupt_disable(uint32_t interrupt)
{
...
# 841 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
FlagStatus adc_interrupt_flag_get(uint32_t flag)
{
...
# 882 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_interrupt_flag_clear(uint32_t flag)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00002400U) + 0x00U)) &= ~((uint32_t)flag);
}
