# 1 "../../driver/GN7153/gn7153.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../driver/GN7153/gn7153.c" 2
# 11 "../../driver/GN7153/gn7153.c"
# 1 "../../include\\user_config.h" 1
# 12 "../../driver/GN7153/gn7153.c" 2
# 1 "../../mcu\\mcu_pin_type.h" 1
# 16 "../../mcu\\mcu_pin_type.h"
...
# 17 "../../mcu\\mcu_pin_type.h" 2
# 13 "../../driver/GN7153/gn7153.c" 2
...
# 15 "../../driver/GN7153/gn7153.c" 2
# 1 "../../include\\dev_reg_address.h" 1
# 16 "../../driver/GN7153/gn7153.c" 2
...
# 19 "../../driver/GN7153/gn7153.c" 2
# 33 "../../driver/GN7153/gn7153.c"
void gn7153_init()
{
...
# 65 "../../driver/GN7153/gn7153.c"
void gn7153_gpio_init()
{



 gpio_mode_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)), ((uint32_t)((uint32_t)0x01U<<(3))));
 gpio_output_options_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), ((uint8_t)(0x00U)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(3) << 0)), ((uint32_t)((uint32_t)0x01U<<(3))));

    gpio_mode_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)), ((uint32_t)((uint32_t)0x01U<<(8))));
 gpio_output_options_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), ((uint8_t)(0x00U)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(3) << 0)), ((uint32_t)((uint32_t)0x01U<<(8))));
# 84 "../../driver/GN7153/gn7153.c"
    gpio_mode_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000400U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), ((uint32_t)((uint32_t)0x01U<<(13))));
 gpio_output_options_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000400U), ((uint8_t)(0x01U)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(3) << 0)), ((uint32_t)((uint32_t)0x01U<<(13))));

}
# 98 "../../driver/GN7153/gn7153.c"
void gn7153_reset()
{

 gpio_bit_reset(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), ((uint32_t)((uint32_t)0x01U<<(3))));
 system_delay_ms(10);
 gpio_bit_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), ((uint32_t)((uint32_t)0x01U<<(3))));

}
# 116 "../../driver/GN7153/gn7153.c"
void gn7153_soft_txdsbl_ctrl(uint8_t ctrl_switch)
{
 if(ctrl_switch == 1){
  ...
  master_reg_byte_write(0x48, tx_ld_soft_txdsbl_reg, 2);
 }
 else{
  uint8_t tx_ld_soft_txdsbl_reg[2];
  tx_ld_soft_txdsbl_reg[0] = 0x60;
...
# 142 "../../driver/GN7153/gn7153.c"
void gn7153_normal_setting()
{

 uint8_t adjust_type = 1;
 ...
 mpd_iphoto_range[0] = 0x57;
 mpd_iphoto_range[1] = 0x02;
 master_reg_byte_write(0x48, mpd_iphoto_range, 2);
 ...
 if(adjust_type == 0){
  ...
  apc_target_value[0] = 0x0F;
  apc_target_value[1] = 0x5F;
  master_reg_byte_write(0x48, apc_target_value, 2);


  uint8_t ld_bias_txdsbl_mask[2];
  ld_bias_txdsbl_mask[0] = 0x06;
  ld_bias_txdsbl_mask[1] = 0x0F;
  master_reg_byte_write(0x48, ld_bias_txdsbl_mask, 2);
 }
 else{
  ...
  upper_value[0] = 0x0E;
  lower_value[1] = 0x00;
  master_reg_byte_write(0x48, lower_value, 2);
  upper_value[1] = 0x04;
  master_reg_byte_write(0x48, upper_value, 2);


  uint8_t ld_bias_txdsbl_mask[2];
  ld_bias_txdsbl_mask[0] = 0x06;
  ld_bias_txdsbl_mask[1] = 0x1F;
  master_reg_byte_write(0x48, ld_bias_txdsbl_mask, 2);
 ...
 uint8_t txflt_reg[2] = {0x62, 0x40};
 master_reg_byte_write(0x48, txflt_reg, 2);




 uint8_t rxtop_reg1[2] = {0x73, 0x4C};
 master_reg_byte_write(0x48, rxtop_reg1, 2);




 uint8_t pulse_gen_reg1[2] = {0x7B, 0x04};
 master_reg_byte_write(0x48, pulse_gen_reg1, 2);


}
# 230 "../../driver/GN7153/gn7153.c"
void gn7153_adc()
{
    uint8_t value[2];
  ...
  value[0] = 0x34;
  value[1] = 0x03;
  master_reg_byte_write(0x48, value, 2);
...
void gn7153_get_temperature(float* temperature)
{
 ...
 master_reg_1byte_size_read(0x48, 0x18, adc_done_conv, 1);
 if (adc_done_conv[0] == 1){
  master_reg_1byte_size_read(0x48, 0x19, adc_out_lo, 1);
  master_reg_1byte_size_read(0x48, 0x1A, adc_out_hi, 1);
...
void gn7153_ld_ibias_monitor_ctrl(uint8_t ctrl_switch)
{
 ...
 master_reg_byte_write(0x48,value, 2);
 master_reg_byte_write(0x48,bias_mon, 2);

}
# 499 "../../driver/GN7153/gn7153.c"
void gn7153_get_ld_ibias(float* ibias)
{
 uint8_t adc_out_lo[1];
 uint8_t adc_out_hi[1];
...
void gn7153_set_ld_ibias(uint16_t ibias){
 ...
 lower_value[0] = 0x0D;
 upper_value[0] = 0x0E;
 lower_value[1] = ibias_set_val[1];
 master_reg_byte_write(0x48, lower_value, 2);
 upper_value[1] = 0x04 | ibias_set_val[0];
 master_reg_byte_write(0x48, upper_value, 2);

}
# 560 "../../driver/GN7153/gn7153.c"
void gn7153_mpd_ibias_monitor_ctrl(uint8_t ctrl_switch)
{
 uint8_t value[2];
 value[0] = 0x15;
...
# 619 "../../driver/GN7153/gn7153.c"
void gn7153_set_ld_imod(uint16_t mod_vcc)
{
 uint8_t txsdo_imod_lo[2];
 uint8_t txsdo_imod_hi[2];

 txsdo_imod_lo[0] = 0x59;
 txsdo_imod_hi[0] = 0x5A;

 uint16_t code = mod_vcc / (0.154*25);
 txsdo_imod_lo[1] = (uint8_t)(code);
 txsdo_imod_hi[1] = (uint8_t)(code >> 8);

 master_reg_byte_write(0x48,txsdo_imod_lo, 2);
 master_reg_byte_write(0x48,txsdo_imod_hi, 2);
}
# 643 "../../driver/GN7153/gn7153.c"
void gn7153_set_tx_ld_cpa(uint8_t value)
{
 ...
 txsdo_cpa_en[0] = 0x33;
 txsdo_cpa_val[0] = 0x5B;

 txsdo_cpa_en[1] = 0x0;
 txsdo_cpa_val[1] = value;

 master_reg_byte_write(0x48,txsdo_cpa_en, 2);
 master_reg_byte_write(0x48,txsdo_cpa_val, 2);

}
# 668 "../../driver/GN7153/gn7153.c"
void gn7153_set_tx_eq_boost(uint8_t value)
{
 ...
 master_reg_byte_write(0x48,tx_eq_boost, 2);

}
# 689 "../../driver/GN7153/gn7153.c"
void gn7153_set_rx_eq_boost(uint16_t value)
{
 uint8_t rx_eq_boost_la_reg[2];
 rx_eq_boost_la_reg[0] = 0x80;
 rx_eq_boost_la_reg[1] = value;
 master_reg_byte_write(0x48, rx_eq_boost_la_reg, 2);

}
# 707 "../../driver/GN7153/gn7153.c"
void gn7153_set_rx_swing(uint16_t value)
{
 uint8_t rx_swing_val_reg[2];
 rx_swing_val_reg[0] = 0x77;
 rx_swing_val_reg[1] = value;
 master_reg_byte_write(0x48, rx_swing_val_reg, 2);
}
# 724 "../../driver/GN7153/gn7153.c"
void gn7153_set_tx_ld_preemph(uint8_t value)
{
 uint8_t txsdo_preemph_en[2];
 uint8_t txsdo_preemph_val[2];

 txsdo_preemph_en[0] = 0x33;
 txsdo_preemph_val[0] = 0x5D;

 txsdo_preemph_en[1] = 0x0;
 txsdo_preemph_val[1] = value;

 master_reg_byte_write(0x48,txsdo_preemph_en, 2);
 master_reg_byte_write(0x48,txsdo_preemph_val, 2);

}
# 749 "../../driver/GN7153/gn7153.c"
void gn7153_set_rx_drv_preemph(uint16_t value)
{
 uint8_t rx_drv_preemph_en[2];
 uint8_t rx_drv_preemph_val[2];
 rx_drv_preemph_en[0] = 0x79;
 rx_drv_preemph_en[1] = 0x00;
 rx_drv_preemph_val[0] = 0x78;
 rx_drv_preemph_val[1] = value;

 master_reg_byte_write(0x48, rx_drv_preemph_en, 2);
 master_reg_byte_write(0x48, rx_drv_preemph_val, 2);
}
# 771 "../../driver/GN7153/gn7153.c"
void gn7153_set_rx_los_threshold(uint8_t los_th){

 uint8_t rx_los_threshold[2];
 rx_los_threshold[0] = 0x91;
 rx_los_threshold[1] = los_th;
 master_reg_byte_write(0x48,rx_los_threshold, 2);

}
# 789 "../../driver/GN7153/gn7153.c"
void gn7153_set_rx_los_hyst(uint8_t los_hyst){

 uint8_t rx_los_hyst[2];
 rx_los_hyst[0] = 0x92;
 rx_los_hyst[1] = los_hyst;
 master_reg_byte_write(0x48,rx_los_hyst, 2);

}
# 807 "../../driver/GN7153/gn7153.c"
void gn7153_temperaturel_Sample_Average(float* temperature)
{
    float temp = 0.0;
  float temp_sum = 0.0;
...
void gn7153_apc_auto_enable_ctrl(uint8_t ctrl_switch)
{
 ...
 master_reg_1byte_size_read(0x48,reg,&apc_reg0xb_value,1);

 reg = 0x6;
 master_reg_1byte_size_read(0x48,reg,&apc_mask,1);

 reg = 0xe;
 master_reg_1byte_size_read(0x48,reg,&apc_ovr,1);
 ...
 if(1 == ctrl_switch)
 {
  ...
  memset(value,0,sizeof(value));
  reg = 0xe;
  temp_data = (apc_ovr & ~(0x1 << 2));
  value[0] = reg;
  value[1] = temp_data;
  master_reg_byte_write(0x48, value, 2);

  apc_reg0xb_value |= 0x1;
  reg = 0xB;
  memset(value,0,sizeof(value));
  value[0] = reg;
