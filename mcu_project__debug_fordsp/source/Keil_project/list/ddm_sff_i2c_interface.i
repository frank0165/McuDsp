# 1 "../../ddm_process/ddm_sff_i2c_interface.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../ddm_process/ddm_sff_i2c_interface.c" 2
# 13 "../../ddm_process/ddm_sff_i2c_interface.c"
# 1 "../../ddm_process/ddm_sff_i2c_interface.h" 1
# 15 "../../ddm_process/ddm_sff_i2c_interface.h"
...
# 16 "../../ddm_process/ddm_sff_i2c_interface.h" 2
...
# 17 "../../ddm_process/ddm_sff_i2c_interface.h" 2
...
# 14 "../../ddm_process/ddm_sff_i2c_interface.c" 2
...
# 15 "../../ddm_process/ddm_sff_i2c_interface.c" 2
...
# 17 "../../ddm_process/ddm_sff_i2c_interface.c" 2
...
# 18 "../../ddm_process/ddm_sff_i2c_interface.c" 2
...
# 19 "../../ddm_process/ddm_sff_i2c_interface.c" 2
...
# 20 "../../ddm_process/ddm_sff_i2c_interface.c" 2
# 36 "../../ddm_process/ddm_sff_i2c_interface.c"
void om_flash_write_reg_byte(uint32_t slave_addr,uint8_t *p_buff,uint32_t buff_len)
{
 uint16_t i;
 uint32_t new_addr;
 ...
 if(slave_addr == 0xa0){
  ...
  flash_write((uint8_t*)a0,new_addr,256);
 }
  ...
  if(offset == 0x6e){
   ...
   new_addr = 0x0807F800U;
   for(i= 0; i < buff_len-1;i++)
   {
    a2[i+offset] = *(p_buff + i + 1);
   }
   flash_write((uint8_t*)a2,new_addr,256);
  }

 }
 else if(slave_addr == 0xb0){
  fmc_erase_single_page(0x0807F400U);
  new_addr = 0x0807F400U;
  for(i= 0; i < buff_len-1;i++)
  {
   b0[i+offset] = *(p_buff + i + 1);
  }
  flash_write((uint8_t*)b0,new_addr,256);
 }
  ...
  if(offset == 0x6e){
   ...
   new_addr = 0x0807F000U;
   for(i= 0; i < buff_len-1;i++)
   {
    b2[i+offset] = *(p_buff + i + 1);
   }
   flash_write((uint8_t*)b2,new_addr,256);
  }
 }
 else if(slave_addr == 0xc0){
  fmc_erase_single_page(0x0807EC00U);
  new_addr = 0x0807EC00U;
  for(i= 0; i < buff_len-1;i++)
  {
   c0[i+offset] = *(p_buff + i + 1);
  }
  flash_write((uint8_t*)c0,new_addr,256);
 }
  ...
  if(offset == 0x6e){
   ...
   new_addr = 0x0807E800U;
   for(i= 0; i < buff_len-1;i++)
   {
    c2[i+offset] = *(p_buff + i + 1);
   }
   flash_write((uint8_t*)c2,new_addr,256);
  }
 }
 return;
}
# 164 "../../ddm_process/ddm_sff_i2c_interface.c"
void om_memory_state_ctrl_write_reg_byte(uint32_t slave_addr,uint8_t *p_buff,uint32_t buff_len)
{
 uint16_t i;
 uint8_t offset = *p_buff;
...
# 250 "../../ddm_process/ddm_sff_i2c_interface.c"
void om_v2_flash_read_reg_byte(I2C_ALL_ADDRESS_INFO *p_address_info,uint8_t *p_buff,uint32_t buff_len)
{
 ...
 if(slave_addr == 0xa0){
  addr_start = 0x0807FC00U + (uint32_t)reg_address;
  flash_read(p_buff,addr_start,len);
 }
 else if(slave_addr == 0xa2){
  addr_start = 0x0807F800U + (uint32_t)reg_address;
  flash_read(p_buff,addr_start,len);

  if((reg_address >= 0x60)&&(reg_address <=0x68 +1)){
   *p_buff = a2[reg_address];
  }
 }
 else if(slave_addr == 0xb0){
  addr_start = 0x0807F400U + (uint32_t)reg_address;
  flash_read(p_buff,addr_start,len);
 }
 else if(slave_addr == 0xb2){
  addr_start = 0x0807F000U + (uint32_t)reg_address;
  flash_read(p_buff,addr_start,len);
  ...
  addr_start = 0x0807EC00U + (uint32_t)reg_address;
  flash_read(p_buff,addr_start,len);
 }
 else if(slave_addr == 0xc2){
  addr_start = 0x0807E800U + (uint32_t)reg_address;
  flash_read(p_buff,addr_start,len);
...
# 325 "../../ddm_process/ddm_sff_i2c_interface.c"
...
# 440 "../../ddm_process/ddm_sff_i2c_interface.c"
...
# 516 "../../ddm_process/ddm_sff_i2c_interface.c"
void om_save_data_config_flash_write(uint8_t *pbuff,uint32_t bufflen)
{
 ...
 fmc_erase_single_page((((0x0807F000U - 0x1400) - 0x19000) - 0x400));
 flash_write((uint8_t*)default_config_value,(((0x0807F000U - 0x1400) - 0x19000) - 0x400),sizeof(default_config_value));

 return;
}
# 548 "../../ddm_process/ddm_sff_i2c_interface.c"
void om_erase_data_config_flash_write(uint8_t *pbuff,uint32_t bufflen)
{
...
# 580 "../../ddm_process/ddm_sff_i2c_interface.c"
void cfg_v2_flash_read_reg_byte(I2C_ALL_ADDRESS_INFO *p_address_info,
  uint8_t *p_buff,uint32_t buff_len)
{
 ...
 if(slave_addr == I2C_FLASH_A8_ADDR){
  addr_start = (((0x0807F000U - 0x1400) - 0x19000) - 0x400) + (uint32_t)reg_address;
  flash_read(p_buff,addr_start,len);
 }

 return;
}
# 627 "../../ddm_process/ddm_sff_i2c_interface.c"
void cmd_common_reg_read(uint8_t regaddr,uint8_t *pbuff,uint32_t bufflen)
{
