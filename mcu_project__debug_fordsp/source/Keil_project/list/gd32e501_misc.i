# 1 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_misc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_misc.c" 2
# 36 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_misc.c"
...
# 37 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_misc.c" 2
# 50 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_misc.c"
void nvic_priority_group_set(uint32_t nvic_prigroup)
{

    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->AIRCR = ((uint32_t)0x05FA0000) | nvic_prigroup;
}
# 64 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_misc.c"
void nvic_irq_enable(uint8_t nvic_irq, uint8_t nvic_irq_pre_priority,
                     uint8_t nvic_irq_sub_priority)
{
    uint32_t temp_priority = 0x00U, temp_pre = 0x00U, temp_sub = 0x00U;

    if(((((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->AIRCR) & (uint32_t)0x700U)==((uint32_t)0x00000700)){
        temp_pre=0U;
        temp_sub=0x4U;
    }else if(((((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->AIRCR) & (uint32_t)0x700U)==((uint32_t)0x00000600)){
        temp_pre=1U;
        temp_sub=0x3U;
    }else if(((((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->AIRCR) & (uint32_t)0x700U)==((uint32_t)0x00000500)){
        temp_pre=2U;
        temp_sub=0x2U;
    }else if(((((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->AIRCR) & (uint32_t)0x700U)==((uint32_t)0x00000400)){
        temp_pre=3U;
        temp_sub=0x1U;
    }else if(((((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->AIRCR) & (uint32_t)0x700U)==((uint32_t)0x00000300)){
        temp_pre=4U;
        temp_sub=0x0U;
    }else{
        nvic_priority_group_set(((uint32_t)0x00000500));
        temp_pre=2U;
        temp_sub=0x2U;
    }
    ...
    ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->IPR[nvic_irq] = (uint8_t)temp_priority;

    ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ISER[nvic_irq >> 0x05U] = (uint32_t)0x01U << (nvic_irq & (uint8_t)0x1FU);
}
...
# 131 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_misc.c"
void nvic_vector_table_set(uint32_t nvic_vict_tab, uint32_t offset)
{
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->VTOR = nvic_vict_tab | (offset & ((uint32_t)0x1FFFFF80));
}
# 148 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_misc.c"
void system_lowpower_set(uint8_t lowpower_mode)
{
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR |= (uint32_t)lowpower_mode;
}
# 165 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_misc.c"
void system_lowpower_reset(uint8_t lowpower_mode)
{
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR &= (~(uint32_t)lowpower_mode);
}
# 180 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_misc.c"
void systick_clksource_set(uint32_t systick_clksource)
{
