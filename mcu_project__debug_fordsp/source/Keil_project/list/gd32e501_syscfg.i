# 1 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_syscfg.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_syscfg.c" 2
# 36 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_syscfg.c"
...
# 37 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_syscfg.c" 2
...
# 60 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_syscfg.c"
void syscfg_bootmode_config(uint8_t syscfg_bootmode)
{

    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x00U)) &= ~((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1))));
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x00U)) |= (uint32_t)syscfg_bootmode;
}
# 81 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_syscfg.c"
void syscfg_dma_remap_enable(uint32_t syscfg_dma_remap)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x00U)) |= syscfg_dma_remap;
}
# 100 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_syscfg.c"
void syscfg_dma_remap_disable(uint32_t syscfg_dma_remap)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x00U)) &= ~syscfg_dma_remap;
}
# 115 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_syscfg.c"
void syscfg_high_current_enable(uint32_t syscfg_high_current)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x00U)) |= syscfg_high_current;
}
# 130 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_syscfg.c"
void syscfg_high_current_disable(uint32_t syscfg_high_current)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x00U)) &= syscfg_high_current;
}
...
void syscfg_vref_enable(void)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x18U)) |= ((uint32_t)((uint32_t)0x01U<<(16)));
}
...
# 166 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_syscfg.c"
void syscfg_pin_reset_mode_config(uint32_t syscfg_pin_reset_mode)
{
    uint32_t reg;

    reg = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x18U));

    reg &= ~((uint32_t)((uint32_t)0x01U<<(24)));
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x18U)) = (reg | syscfg_pin_reset_mode);
}
# 187 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_syscfg.c"
void syscfg_exti_line_config(uint8_t exti_port, uint8_t exti_pin)
{
...
# 232 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_syscfg.c"
void syscfg_lock_config(uint32_t syscfg_lock)
{
...
# 275 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_syscfg.c"
void syscfg_flag_clear(uint32_t syscfg_flag)
{
