# 1 "../../other/trigger_interrupt_mode.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../other/trigger_interrupt_mode.c" 2
...
# 2 "../../other/trigger_interrupt_mode.c" 2
# 1 "../../other/trigger_interrupt_mode.h" 1
# 37 "../../other/trigger_interrupt_mode.h"
void mcu_trigger_mode_init();
# 3 "../../other/trigger_interrupt_mode.c" 2
...
# 4 "../../other/trigger_interrupt_mode.c" 2
# 1 "../../mcu\\mcu_pin_type.h" 1
# 17 "../../mcu\\mcu_pin_type.h"
# 1 "../../include\\user_config.h" 1
# 18 "../../mcu\\mcu_pin_type.h" 2
# 5 "../../other/trigger_interrupt_mode.c" 2
# 22 "../../other/trigger_interrupt_mode.c"
void mcu_trigger_gpion_init()
{

 gpio_mode_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000400U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)), ((uint32_t)((uint32_t)0x01U<<(15))));
 gpio_output_options_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000400U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(3) << 0)), ((uint32_t)((uint32_t)0x01U<<(15))));

}
# 43 "../../other/trigger_interrupt_mode.c"
void mcu_trigger_mode_init()
{
 mcu_trigger_gpion_init();
# 65 "../../other/trigger_interrupt_mode.c"
 nvic_irq_enable(EXTI4_15_IRQn, 0, TRIGGER_EXIT15_IRQ_PRI);

 syscfg_exti_line_config(((uint8_t)0x01U), ((uint8_t)0x0FU));
