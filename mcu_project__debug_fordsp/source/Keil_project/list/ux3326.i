# 1 "../../driver/UX3326/ux3326.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../driver/UX3326/ux3326.c" 2
# 11 "../../driver/UX3326/ux3326.c"
...
# 12 "../../driver/UX3326/ux3326.c" 2
# 1 "../../mcu\\mcu_pin_type.h" 1
# 13 "../../driver/UX3326/ux3326.c" 2
...
void ux3326_gpio_init()
{
 ...
 gpio_mode_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000800U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)), ((uint32_t)((uint32_t)0x01U<<(12))));
 gpio_output_options_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000800U), ((uint8_t)(0x00U)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(3) << 0)), ((uint32_t)((uint32_t)0x01U<<(12))));


 gpio_mode_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000800U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), ((uint32_t)((uint32_t)0x01U<<(13))));
 gpio_output_options_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000800U), ((uint8_t)(0x00U)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(3) << 0)), ((uint32_t)((uint32_t)0x01U<<(13))));

}
# 126 "../../driver/UX3326/ux3326.c"
void ux3326_reset()
{
...
# 145 "../../driver/UX3326/ux3326.c"
void ux3326_soft_txdsbl_ctrl(uint8_t ctrl_switch)
{
 if(ctrl_switch == 1){
  uint8_t tx_ld_soft_txdsbl_reg[2];
  tx_ld_soft_txdsbl_reg[0] = 0x00;
  tx_ld_soft_txdsbl_reg[1] = 0x0A;
  master_reg_byte_write(0xC6, tx_ld_soft_txdsbl_reg, 2);
 }
 else{
  uint8_t tx_ld_soft_txdsbl_reg[2];
  tx_ld_soft_txdsbl_reg[0] = 0x00;
  tx_ld_soft_txdsbl_reg[1] = 0x02;
  master_reg_byte_write(0xC6, tx_ld_soft_txdsbl_reg, 2);
 }

}
# 171 "../../driver/UX3326/ux3326.c"
void ux3326_normal_setting()
{
 uint16_t i;
 uint8_t reg_val[2];
 ...
 for(i=0;i<40;i++)
 {
  reg_val[0] = i;
  reg_val[1] = t0[i];
  master_reg_byte_write(0xC6, reg_val, 2);
 }

}
# 195 "../../driver/UX3326/ux3326.c"
void ux3326_source_sink_select(uint8_t ctrl_switch)
{
  uint8_t value[2];
  value[0] = 0x61;
  ...
  master_reg_byte_write(0xC6,value, 2);
}
# 217 "../../driver/UX3326/ux3326.c"
void ux3326_get_temperature(float* temperature)
{
 ...
 master_reg_1byte_size_read(0xC6, 0x2E, temp_data_hi, 1);
 master_reg_1byte_size_read(0xC6, 0x2F, temp_data_lo, 1);

 temp_data = temp_data_hi[0] * 256 + temp_data_lo[0];
 *temperature = (slope * temp_data + offset) / 256;

}
# 242 "../../driver/UX3326/ux3326.c"
void ux3326_get_voltage(float* vcc)
{
 ...
 master_reg_1byte_size_read(0xC6, 0x30, vcc_data_hi, 1);
 master_reg_1byte_size_read(0xC6, 0x31, vcc_data_lo, 1);

 vcc_data = vcc_data_hi[0] * 256 + vcc_data_lo[0];
 *vcc = (slope * vcc_data + offset) * 0.0001;
 ddm_adc_out_val.voltage_adc_out_2 = vcc_data;
}
# 267 "../../driver/UX3326/ux3326.c"
void ux3326_get_ld_ibias(float* ibias)
{
 ...
 master_reg_1byte_size_read(0xC6, 0x32, ibias_data_hi, 1);
 master_reg_1byte_size_read(0xC6, 0x33, ibias_data_lo, 1);
...
void ux3326_set_ld_ibias(uint16_t ibias){
 ...
 upper_value[0] = 0x04;
 lower_value[0] = 0x05;
 upper_value[1] = ibias_set_val[1];
 master_reg_byte_write(0xC6, upper_value, 2);
 lower_value[1] = ibias_set_val[0];
 master_reg_byte_write(0xC6, lower_value, 2);

}
# 322 "../../driver/UX3326/ux3326.c"
void ux3326_set_ld_imod(uint16_t imod)
{
 uint8_t txsdo_imod_lo[2];
 uint8_t txsdo_imod_hi[2];

 txsdo_imod_hi[0] = 0x06;
 txsdo_imod_lo[0] = 0x07;

 uint16_t code = imod / 0.112;
 txsdo_imod_hi[1] = code >> 2;
 txsdo_imod_lo[1] = code & 3;

 master_reg_byte_write(0xC6,txsdo_imod_hi, 2);
 master_reg_byte_write(0xC6,txsdo_imod_lo, 2);
}
# 346 "../../driver/UX3326/ux3326.c"
void ux3326_get_mpd_ibias(float* mpd_ibias)
{
 ...
 master_reg_1byte_size_read(0xC6, 0x34, impd_data_hi, 1);
 master_reg_1byte_size_read(0xC6, 0x35, impd_data_lo, 1);
...
# 370 "../../driver/UX3326/ux3326.c"
void ux3326_set_tx_ld_cpa(uint8_t value)
{
 uint8_t txsdo_cpa_val[2];

 txsdo_cpa_val[0] = 0x0A;
 txsdo_cpa_val[1] = value;

 master_reg_byte_write(0xC6,txsdo_cpa_val, 2);

}
# 390 "../../driver/UX3326/ux3326.c"
void ux3326_set_rx_swing(uint16_t value)
{
 uint8_t rx_swing_val_reg[2];
 rx_swing_val_reg[0] = 0x13;
 rx_swing_val_reg[1] = value;
 master_reg_byte_write(0xC6, rx_swing_val_reg, 2);
}
# 407 "../../driver/UX3326/ux3326.c"
void ux3326_set_rx_los_threshold(uint8_t los_th){
 uint8_t rx_los_threshold[2];
 rx_los_threshold[0] = 0x1C;
 rx_los_threshold[1] = los_th;
 master_reg_byte_write(0xC6,rx_los_threshold, 2);

}
# 424 "../../driver/UX3326/ux3326.c"
void ux3326_set_rx_los_hyst(uint8_t los_hyst){
 ...
 master_reg_1byte_size_read(0xC6, 0x14, &rx_los_hyst_old, 1);

 rx_los_hyst_old = rx_los_hyst_old & mask;
 rx_los_hyst[1] = (rx_los_hyst_old | (los_hyst << 3));
 master_reg_byte_write(0xC6,rx_los_hyst, 2);

}
# 448 "../../driver/UX3326/ux3326.c"
void ux3326_temperaturel_Sample_Average(float* temperature)
{
    float temp = 0.0;
  float temp_sum = 0.0;
...
void ux3326_apc_auto_enable_ctrl(uint8_t ctrl_switch)
{
 ...
 reg = 0x0;
 master_reg_1byte_size_read(0xC6, reg, &tx_reg0x0_value,1);


 reg = 0x02;
 master_reg_1byte_size_read(0xC6, reg, &tx_reg0x2_value,1);
...
void ux3326_apc_target_voltage(float voltage_target)
{
 ...
 master_reg_byte_write(0xC6, tx_imod_hi, 2);
 master_reg_byte_write(0xC6, tx_imod_lo, 2);
