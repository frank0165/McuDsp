# 1 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cmp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cmp.c" 2
# 37 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cmp.c"
...
# 38 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cmp.c" 2
# 47 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cmp.c"
void cmp_deinit(void)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x0000001CU) + 0x00000000U)) = ((uint32_t)0x00000000U);
}
# 79 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cmp.c"
void cmp_mode_init(uint32_t cmp_periph, operating_mode_enum operating_mode, inverting_input_enum inverting_input, cmp_hysteresis_enum output_hysteresis)
{
    if(((uint32_t)0x00000000U) == cmp_periph){

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x0000001CU) + 0x00000000U)) &= ~(uint32_t)(((0xFFFFFFFFUL << (2)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) | ((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(6)))) | ((0xFFFFFFFFUL << (12)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(13)))) );
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x0000001CU) + 0x00000000U)) |= (((0xFFFFFFFFUL << (2)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) & ((uint32_t)(operating_mode) << 2)) | (((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(6)))) & ((uint32_t)(inverting_input) << 4)) | (((0xFFFFFFFFUL << (12)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(13)))) & ((uint32_t)(output_hysteresis) << 12));
    }else{

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x0000001CU) + 0x00000000U)) &= ~(uint32_t)(((0xFFFFFFFFUL << (18)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(19)))) | ((0xFFFFFFFFUL << (20)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(22)))) | ((0xFFFFFFFFUL << (28)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(29)))) );
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x0000001CU) + 0x00000000U)) |= (((0xFFFFFFFFUL << (18)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(19)))) & ((uint32_t)(operating_mode) << 18)) | (((0xFFFFFFFFUL << (20)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(22)))) & ((uint32_t)(inverting_input) << 20)) | (((0xFFFFFFFFUL << (28)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(29)))) & ((uint32_t)(output_hysteresis) << 28));
    }
}
# 112 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cmp.c"
void cmp_output_init(uint32_t cmp_periph, cmp_output_enum output_slection, uint32_t output_polarity)
{
    if(((uint32_t)0x00000000U) == cmp_periph){

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x0000001CU) + 0x00000000U)) &= ~(uint32_t)((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(10))));
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x0000001CU) + 0x00000000U)) |= (((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(10)))) & ((uint32_t)(output_slection) << 8));

        if(((uint32_t)0x00000001U) == output_polarity){
            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x0000001CU) + 0x00000000U)) |= ((uint32_t)((uint32_t)0x01U<<(11)));
        }else{
            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x0000001CU) + 0x00000000U)) &= ~((uint32_t)((uint32_t)0x01U<<(11)));
        }
    }else{

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x0000001CU) + 0x00000000U)) &= ~(uint32_t)((0xFFFFFFFFUL << (24)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(26))));
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x0000001CU) + 0x00000000U)) |= (((0xFFFFFFFFUL << (24)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(26)))) & ((uint32_t)(output_slection) << 24));

        if(((uint32_t)0x00000001U) == output_polarity){
            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x0000001CU) + 0x00000000U)) |= ((uint32_t)((uint32_t)0x01U<<(27)));
        }else{
            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x0000001CU) + 0x00000000U)) &= ~((uint32_t)((uint32_t)0x01U<<(27)));
        }
    }
}
# 145 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cmp.c"
void cmp_enable(uint32_t cmp_periph)
{
    if(((uint32_t)0x00000000U) == cmp_periph){
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x0000001CU) + 0x00000000U)) |= ((uint32_t)((uint32_t)0x01U<<(0)));
    }else{
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x0000001CU) + 0x00000000U)) |= ((uint32_t)((uint32_t)0x01U<<(16)));
    }
}
# 162 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cmp.c"
void cmp_disable(uint32_t cmp_periph)
{
    if(((uint32_t)0x00000000U) == cmp_periph){
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x0000001CU) + 0x00000000U)) &= ~((uint32_t)((uint32_t)0x01U<<(0)));
...
void cmp_switch_enable(void)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x0000001CU) + 0x00000000U)) |= ((uint32_t)((uint32_t)0x01U<<(1)));
}
...
void cmp_window_enable(void)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x0000001CU) + 0x00000000U)) |= ((uint32_t)((uint32_t)0x01U<<(23)));
}
...
# 223 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cmp.c"
void cmp_lock_enable(uint32_t cmp_periph)
{
    if(((uint32_t)0x00000000U) == cmp_periph){

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x0000001CU) + 0x00000000U)) |= ((uint32_t)((uint32_t)0x01U<<(15)));
    }else{

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x0000001CU) + 0x00000000U)) |= ((uint32_t)((uint32_t)0x01U<<(31)));
    }
}
# 242 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cmp.c"
uint32_t cmp_output_level_get(uint32_t cmp_periph)
{
    if(((uint32_t)0x00000000U) == cmp_periph){

        if((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x0000001CU) + 0x00000000U)) & ((uint32_t)((uint32_t)0x01U<<(14)))){
            return ((uint32_t)0x00000001U);
        }else{
            return ((uint32_t)0x00000000U);
        }
    }else{

        if((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x0000001CU) + 0x00000000U)) & ((uint32_t)((uint32_t)0x01U<<(30)))){
            return ((uint32_t)0x00000001U);
        }else{
            return ((uint32_t)0x00000000U);
        }
