# 1 "../../mcu/GDE501_fireware/Utilities/gd32e501_eval.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../mcu/GDE501_fireware/Utilities/gd32e501_eval.c" 2
# 36 "../../mcu/GDE501_fireware/Utilities/gd32e501_eval.c"
# 1 "../../mcu/GDE501_fireware/Utilities/gd32e501_eval.h" 1
# 43 "../../mcu/GDE501_fireware/Utilities/gd32e501_eval.h"
...
# 44 "../../mcu/GDE501_fireware/Utilities/gd32e501_eval.h" 2
...
# 37 "../../mcu/GDE501_fireware/Utilities/gd32e501_eval.c" 2


static const uint32_t GPIO_PORT[4U] = {((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U),
                                               ((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U),
                                               ((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U),
                                               ((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U)};

static const uint32_t GPIO_PIN[4U] = {((uint32_t)((uint32_t)0x01U<<(1))),
                                               ((uint32_t)((uint32_t)0x01U<<(2))),
                                               ((uint32_t)((uint32_t)0x01U<<(12))),
                                               ((uint32_t)((uint32_t)0x01U<<(15)))};

static const rcu_periph_enum COM_CLK[1U] = {RCU_USART0};

static const uint32_t COM_TX_PIN[1U] = {((uint32_t)((uint32_t)0x01U<<(9)))};

static const uint32_t COM_RX_PIN[1U] = {((uint32_t)((uint32_t)0x01U<<(10)))};

static const rcu_periph_enum GPIO_CLK[4U] = {RCU_GPIOA,
                                               RCU_GPIOA,
                                               RCU_GPIOA,
                                               RCU_GPIOA};

static const uint32_t KEY_PORT[2U] = {((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U),
                                               ((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000800U)
                                               };

static const uint32_t KEY_PIN[2U] = {((uint32_t)((uint32_t)0x01U<<(0))),
                                               ((uint32_t)((uint32_t)0x01U<<(13)))
                                               };

static const rcu_periph_enum KEY_CLK[2U] = {RCU_GPIOA,
                                               RCU_GPIOC
                                               };

static const exti_line_enum KEY_EXTI_LINE[2U] = {EXTI_0,
                                                   EXTI_13
                                                   };

static const uint8_t KEY_PORT_SOURCE[2U] = {((uint8_t)0x00U),
                                                   ((uint8_t)0x02U)
                                                   };

static const uint8_t KEY_PIN_SOURCE[2U] = {((uint8_t)0x00U),
                                                   ((uint8_t)0x0DU)
                                                   };

static const uint8_t KEY_IRQn[2U] = {EXTI0_1_IRQn,
                                                   EXTI4_15_IRQn
                                                   };
# 99 "../../mcu/GDE501_fireware/Utilities/gd32e501_eval.c"
void gd_eval_led_init(led_typedef_enum lednum)
{

    rcu_periph_clock_enable(GPIO_CLK[lednum]);

    gpio_mode_set(GPIO_PORT[lednum], (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)), GPIO_PIN[lednum]);
    gpio_output_options_set(GPIO_PORT[lednum], ((uint8_t)(0x00U)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(3) << 0)), GPIO_PIN[lednum]);

    (*(volatile uint32_t *)(uint32_t)((GPIO_PORT[lednum]) + 0x00000028U)) = GPIO_PIN[lednum];
}
# 120 "../../mcu/GDE501_fireware/Utilities/gd32e501_eval.c"
void gd_eval_led_on(led_typedef_enum lednum)
{
    (*(volatile uint32_t *)(uint32_t)((GPIO_PORT[lednum]) + 0x00000018U)) = GPIO_PIN[lednum];
}
# 135 "../../mcu/GDE501_fireware/Utilities/gd32e501_eval.c"
void gd_eval_led_off(led_typedef_enum lednum)
{
    (*(volatile uint32_t *)(uint32_t)((GPIO_PORT[lednum]) + 0x00000028U)) = GPIO_PIN[lednum];
}
# 150 "../../mcu/GDE501_fireware/Utilities/gd32e501_eval.c"
void gd_eval_led_toggle(led_typedef_enum lednum)
{
    (*(volatile uint32_t *)(uint32_t)((GPIO_PORT[lednum]) + 0x0000002CU)) = GPIO_PIN[lednum];
}
# 166 "../../mcu/GDE501_fireware/Utilities/gd32e501_eval.c"
void gd_eval_key_init(key_typedef_enum keynum, keymode_typedef_enum keymode)
{
    ...
    gpio_mode_set(KEY_PORT[keynum], (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)), KEY_PIN[keynum]);
...
# 196 "../../mcu/GDE501_fireware/Utilities/gd32e501_eval.c"
FlagStatus gd_eval_key_state_get(key_typedef_enum keynum)
{
    return gpio_input_bit_get(KEY_PORT[keynum], KEY_PIN[keynum]);
}
# 208 "../../mcu/GDE501_fireware/Utilities/gd32e501_eval.c"
void gd_eval_com_init(uint32_t com)
{
    uint32_t COM_ID;
    ...
    gpio_af_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) & ((uint32_t)(1) << 0)), COM_TX_PIN[COM_ID]);


    gpio_af_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) & ((uint32_t)(1) << 0)), COM_RX_PIN[COM_ID]);


    gpio_mode_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(2) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), COM_TX_PIN[COM_ID]);
    gpio_output_options_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), ((uint8_t)(0x00U)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), COM_TX_PIN[COM_ID]);


    gpio_mode_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(2) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), COM_RX_PIN[COM_ID]);
    gpio_output_options_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), ((uint8_t)(0x00U)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), COM_RX_PIN[COM_ID]);


    usart_deinit(com);
    usart_baudrate_set(com, 115200U);
    usart_receive_config(com, (((uint32_t)((uint32_t)0x01U<<(2))) & ((uint32_t)(1) << 2)));
    usart_transmit_config(com, (((uint32_t)((uint32_t)0x01U<<(3))) & ((uint32_t)(1) << 3)));
