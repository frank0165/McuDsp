# 1 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_dbg.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_dbg.c" 2
# 36 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_dbg.c"
...
# 37 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_dbg.c" 2
# 46 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_dbg.c"
void dbg_deinit(void)
{
    (*(volatile uint32_t *)(uint32_t)(((uint32_t)0xE0044000U) + 0x00000004U)) = ((uint32_t)0x00000000U);
    (*(volatile uint32_t *)(uint32_t)(((uint32_t)0xE0044000U) + 0x00000008U)) = ((uint32_t)0x00000000U);
}
...
uint32_t dbg_id_get(void)
{
    return (*(volatile uint32_t *)(uint32_t)(((uint32_t)0xE0044000U) + 0x00000000U));
}
# 73 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_dbg.c"
void dbg_low_power_enable(uint32_t dbg_low_power)
{
    (*(volatile uint32_t *)(uint32_t)(((uint32_t)0xE0044000U) + 0x00000004U)) |= dbg_low_power;
}
# 88 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_dbg.c"
void dbg_low_power_disable(uint32_t dbg_low_power)
{
    (*(volatile uint32_t *)(uint32_t)(((uint32_t)0xE0044000U) + 0x00000004U)) &= ~dbg_low_power;
}
# 115 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_dbg.c"
void dbg_periph_enable(dbg_periph_enum dbg_periph)
{
    ((*(volatile uint32_t *)(uint32_t)(((uint32_t)0xE0044000U) + ((uint32_t)(dbg_periph) >> 6)))) |= ((uint32_t)((uint32_t)0x01U<<(((uint32_t)(dbg_periph) & 0x1FU))));
}
# 142 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_dbg.c"
void dbg_periph_disable(dbg_periph_enum dbg_periph)
{
    ((*(volatile uint32_t *)(uint32_t)(((uint32_t)0xE0044000U) + ((uint32_t)(dbg_periph) >> 6)))) &= ~((uint32_t)((uint32_t)0x01U<<(((uint32_t)(dbg_periph) & 0x1FU))));
}
