# 1 "../../tec_control/tec_driver.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../tec_control/tec_driver.c" 2
# 13 "../../tec_control/tec_driver.c"
# 1 "../../tec_control/tec_data_type.h" 1
# 16 "../../tec_control/tec_data_type.h"
...
# 17 "../../tec_control/tec_data_type.h" 2
...
# 14 "../../tec_control/tec_driver.c" 2
# 31 "../../tec_control/tec_driver.c"
void tec_release_limit_refresh()
{
 sgm41296_tec_release_limit_refresh();
 return;
}
# 49 "../../tec_control/tec_driver.c"
