# 1 "../../thd_dsp_download_release_V0_0/ip_op.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../thd_dsp_download_release_V0_0/ip_op.c" 2
...
# 10 "../../thd_dsp_download_release_V0_0/ip_op.c" 2
# 1 "../../thd_dsp_download_release_V0_0/reg_op.h" 1
# 14 "../../thd_dsp_download_release_V0_0/reg_op.h"
# 1 "../../thd_dsp_download_release_V0_0/mailbox_reg.h" 1
# 21 "../../thd_dsp_download_release_V0_0/mailbox_reg.h"
...
# 15 "../../thd_dsp_download_release_V0_0/reg_op.h" 2
...
# 11 "../../thd_dsp_download_release_V0_0/ip_op.c" 2
...
# 13 "../../thd_dsp_download_release_V0_0/ip_op.c" 2
# 1 "../../thd_dsp_download_release_V0_0/sre_errcode.h" 1
# 14 "../../thd_dsp_download_release_V0_0/ip_op.c" 2
...
# 15 "../../thd_dsp_download_release_V0_0/ip_op.c" 2
...
# 16 "../../thd_dsp_download_release_V0_0/ip_op.c" 2
...
# 17 "../../thd_dsp_download_release_V0_0/ip_op.c" 2

VOID SRE_McuEnable(UINT8 en)
{
    MailboxRegTbl *mangeTbl = (MailboxRegTbl *)0x0;
    dsp_fsl_reg_write((UINT32)((UINTPTR)(&mangeTbl->mcuEnable)), (UINT32)en);
}
...
VOID SRE_WriteBuff2Sram(UINT32 sramAddr, UINT32 *buff, UINT32 wordsLen)
{
    ...
    while (wrodSend < wordsLen) {
        dsp_fsl_reg_write((UINT32)((UINTPTR)(&mangeTbl->sramRemapAddr)), sramAddr + (wrodSend * 4));
        if ((wrodSend + g_regMaxOpNum) > wordsLen) {
            wordOnce = wordsLen - wrodSend;
        } else {
            wordOnce = g_regMaxOpNum;
        }
        dsp_fsl_continue_write((UINT32)((UINTPTR)(&mangeTbl->sramRemapData)), (UINT8 *)&buff[wrodSend], ((wordOnce) << 2));
        wrodSend += wordOnce;
    }
...
VOID SRE_DownloadFirmware(FwSecS *fwManage)
{
    ...
    UINT32 i;
    UINT32 addr;
    dsp_fsl_reg_write((UINT32)((UINTPTR)(&mangeTbl->mcuEnable)), 0);
    dsp_fsl_reg_write((UINT32)((UINTPTR)(&mangeTbl->downloafdFwEn)), 1);
    dsp_fsl_reg_write((UINT32)((UINTPTR)(&mangeTbl->mcuEnable)), 1);
    ...
    dsp_fsl_reg_write((UINT32)((UINTPTR)(&mangeTbl->mcuEnable)), 0);
    dsp_fsl_reg_write((UINT32)((UINTPTR)(&mangeTbl->downloafdFwEn)), 0);
    dsp_fsl_reg_write((UINT32)((UINTPTR)(&mangeTbl->mcuEnable)), 1);
}
...
VOID SRE_GetSramBuff(UINT32 sramAddr, UINT32 *buff, UINT32 wordLen)
{
    ...
    while (wrodRead < wordLen) {
        dsp_fsl_reg_write((UINT32)((UINTPTR)(&mangeTbl->sramRemapAddr)), sramAddr + (wrodRead * 4));
        if ((wrodRead + g_regMaxOpNum) > wordLen) {
            wordOnce = wordLen - wrodRead;
        } else {
            wordOnce = g_regMaxOpNum;
        }
        dsp_fsl_continue_read((UINT32)((UINTPTR)(&mangeTbl->sramRemapData)), (UINT8 *)&buff[wrodRead], ((wordOnce) << 2));
        wrodRead += wordOnce;
    }
...
# 94 "../../thd_dsp_download_release_V0_0/ip_op.c"
UINT32 SRE_CmdSend(UINT32 funcCata, UINT32 func, UINT32 *inputPara, UINT32 *outputPara, UINT8 needWait)
{
    MailBoxManage *mangeTbl = (MailBoxManage *)0x0;
    UINT8 i;
    ...
    funPara = &op[func];
    dsp_fsl_reg_write((UINT32)((UINTPTR)(&mangeTbl->cmd.funDef)), (funcCata << 16) | func);
    if ((funPara->inputParaNum != 0) && (inputPara == 0)) {
        return ((0x11 << 24) | (0x1e));
    }
    for (i = 0; i < funPara->inputParaNum; i++) {
        dsp_fsl_reg_write((UINT32)((UINTPTR)(&mangeTbl->cmd.inPara[i])), inputPara[i]);
    }
    dsp_fsl_reg_write((UINT32)((UINTPTR)(&mangeTbl->cmd.cmdFlag)), 0x00005A5A);
    if (needWait == 0) {
        return (UINT32)0;
    }
    ...
    timeOutMs = 15000;
    startTimeCntMs = g_mcu_vars_param.g_sys_tick_period;
    do {
        dsp_fsl_reg_read((UINT32)((UINTPTR)(&mangeTbl->re.cmdFlag)), &(finishedFlag));
        waitTimeCntMs = g_mcu_vars_param.g_sys_tick_period - startTimeCntMs;


    } while (((finishedFlag & 0xFFFF0000) != 0xA5A50000) && (waitTimeCntMs < timeOutMs));
    if (waitTimeCntMs >= timeOutMs) {
        return ((0x11 << 24) | (0x1C));
    }
    dsp_fsl_reg_read((UINT32)((UINTPTR)(&mangeTbl->re.ret)), &(ret));
    if ((funPara->outputParaNum != 0) && (outputPara == 0)) {
        return ((0x11 << 24) | (0x1D));
    }
    for (i = 0; i < funPara->outputParaNum; i++) {
        dsp_fsl_reg_read((UINT32)((UINTPTR)(&mangeTbl->re.outPara[i])), &(outputPara[i]));
    }
    return ret;
}
...
UINT32 SRE_GetCmdResult(UINT32 funcCata, UINT32 func, UINT32 *outputPara, UINT32 *finish)
{
    ...
    if ((finishedFlag & 0xFFFF0000) != 0xA5A50000) {
        *finish = 0;
        return (UINT32)0;
    }
    *finish = 1;
...
# 202 "../../thd_dsp_download_release_V0_0/ip_op.c"
    startTimeMs = g_mcu_vars_param.g_sys_tick_period;
    do
    {
        endTimeMs = g_mcu_vars_param.g_sys_tick_period - startTimeMs;
        ret = SRE_HpllSetup(workMode);
    }while(ret != (UINT32)0 && endTimeMs <100);
    ...
    system_delay_ms(100);
# 237 "../../thd_dsp_download_release_V0_0/ip_op.c"
    SRE_DownloadFirmware((FwSecS *)fwAddr);

    val = 0xffffffff;
    dsp_fsl_reg_read((UINT32)((UINTPTR)(&mangeTbl->mcuEnable)), &(val));
    if(val == 0)
    {
         memset(g_dsp_info,0,sizeof(g_dsp_info));
    ...
    modePara->isCfgFlag = 1;
    modePara->txEnableMask = 0x3;
    modePara->rxEnableMask = 0x3;
...
# 441 "../../thd_dsp_download_release_V0_0/ip_op.c"
    inputPara[0] = 0x2;
    inputPara[1] = 0x1;
    ret = SRE_CmdSend(API_RUN_CTRL_CAT, CHIP_RUN, inputPara, outputPara, 9);
    if (ret != (UINT32)0) {
