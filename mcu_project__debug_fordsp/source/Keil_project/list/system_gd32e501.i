# 1 "../../mcu/GDE501_fireware/Firmware/CMSIS/GD/GD32E501/Source/system_gd32e501.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../mcu/GDE501_fireware/Firmware/CMSIS/GD/GD32E501/Source/system_gd32e501.c" 2
# 36 "../../mcu/GDE501_fireware/Firmware/CMSIS/GD/GD32E501/Source/system_gd32e501.c"
...
# 37 "../../mcu/GDE501_fireware/Firmware/CMSIS/GD/GD32E501/Source/system_gd32e501.c" 2
# 77 "../../mcu/GDE501_fireware/Firmware/CMSIS/GD/GD32E501/Source/system_gd32e501.c"
uint32_t SystemCoreClock = (uint32_t)(100000000);
static void system_clock_100m_irc8m(void);
...
void SystemInit (void)
{
    ...
    do{ volatile uint32_t i; if(0 != 0x50){ (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x00000004U)) |= (((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(8) << 4)); for(i=0; i<0x50; i++){ } (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x00000004U)) |= (((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(9) << 4)); for(i=0; i<0x50; i++){ } } }while(0);
    ...
    nvic_vector_table_set(((uint32_t)0x08000000),(uint32_t)0x00);
...
# 265 "../../mcu/GDE501_fireware/Firmware/CMSIS/GD/GD32E501/Source/system_gd32e501.c"
static void system_clock_100m_irc8m(void)
{
    uint32_t timeout = 0U;
    ...
    do{
        timeout++;
        stab_flag = ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x00000000U)) & ((uint32_t)((uint32_t)0x01U<<(1))));
    }
    while((0U == stab_flag) && (((uint16_t)0x0500) != timeout));


    if(0U == ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x00000000U)) & ((uint32_t)((uint32_t)0x01U<<(1))))){
        while(1){
        }
    }

    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x00000000U)) = ((*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x00000000U)) & (~((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(2)))))) | ((uint8_t)0x04U);
    ...
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x00000004U)) |= ((uint32_t)0x00000000U | (((uint32_t)((uint32_t)0x01U<<(27))) | (((0xFFFFFFFFUL << (18)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(21)))) & ((uint32_t)(8) << 18))));
    ...
    while(0U == ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x00000004U)) & (((0xFFFFFFFFUL << (2)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) & ((uint32_t)(2) << 2)))){
    }
}
# 367 "../../mcu/GDE501_fireware/Firmware/CMSIS/GD/GD32E501/Source/system_gd32e501.c"
