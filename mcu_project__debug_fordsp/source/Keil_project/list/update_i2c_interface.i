# 1 "../../update/update_i2c_interface.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../update/update_i2c_interface.c" 2
# 13 "../../update/update_i2c_interface.c"
...
# 14 "../../update/update_i2c_interface.c" 2
...
# 15 "../../update/update_i2c_interface.c" 2
...
# 16 "../../update/update_i2c_interface.c" 2
...
# 17 "../../update/update_i2c_interface.c" 2
...
void upgrade_dev_version_reg_read(uint8_t regaddr,uint8_t *pbuff,uint32_t
  bufflen);
# 18 "../../update/update_i2c_interface.c" 2
...
# 19 "../../update/update_i2c_interface.c" 2
...
# 21 "../../update/update_i2c_interface.c" 2

unsigned char data_str[] = "Apr 30 2025";
unsigned char time_str[] = "20:38:23";


uint8_t g_crc_is_ok = CRC_NO_DOING;
# 45 "../../update/update_i2c_interface.c"
void update_app_write_reg_byte(uint8_t *p_buff,uint32_t buff_len)
{
 ...
 if(0x02 == p_buff[1] || 0x01 == p_buff[1])
 {

  ret = comm_update_write_mem_one_page_to_flash(((uint32_t)0x0801F800),
   &p_buff[idx],write_len);
 }

 if(0x02 == p_buff[1])
 {
  comm_update_write_to_flash(((uint32_t)0x0801F800));

 }


 if(0x03 == p_buff[1] && buff_len >= 6)
 {
  ...
  printf("write to address:0x%x, pkt_len:%u\r\n",((uint32_t)0x0801F800),g_pkt_count_to_flash);
  crc_flash_result = om_flash_block_data_calculate_crc32(((uint32_t)0x0801F800),g_pkt_count_to_flash);
...
# 194 "../../update/update_i2c_interface.c"
void update_firmware_write_reg_byte(uint8_t *p_buff,uint32_t buff_len)
{
 ...
 if(0x02 == p_buff[1] || 0x01 == p_buff[1])
 {
  ...
  ret = comm_update_write_mem_one_page_to_flash(((0x0807F000U - 0x1400) - 0x19000),
   &p_buff[2],write_len);
 }

 if(0x02 == p_buff[1])
 {
  comm_update_write_to_flash(((0x0807F000U - 0x1400) - 0x19000));
# 283 "../../update/update_i2c_interface.c"
 }
 ...
 if(0x03 == p_buff[1] && buff_len >= 6)
 {
  ...
  printf("write to address:0x%x, pkt_len:%u\r\n",((0x0807F000U - 0x1400) - 0x19000),g_pkt_count_to_flash);
  crc_flash_result = om_flash_block_data_calculate_crc32(((0x0807F000U - 0x1400) - 0x19000),g_pkt_count_to_flash);
  printf("crc_flash_result:0x%x\r\n",crc_flash_result);
...
# 343 "../../update/update_i2c_interface.c"
void upgrade_dev_version_reg_read(uint8_t regaddr,uint8_t *pbuff,uint32_t bufflen)
{
 ...
 memcpy(&tmp[offset],"Apr 30 2025",12);
 offset += 12;


 memcpy(&tmp[offset],"20:38:23",9);
 offset += 9;
...
# 406 "../../update/update_i2c_interface.c"
void update_user_boot_write_reg_byte(uint8_t *p_buff,uint32_t buff_len)
{
# 517 "../../update/update_i2c_interface.c"
}
