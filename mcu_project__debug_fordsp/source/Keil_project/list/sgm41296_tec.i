# 1 "../../other/sgm41296_TEC/sgm41296_tec.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../other/sgm41296_TEC/sgm41296_tec.c" 2
# 12 "../../other/sgm41296_TEC/sgm41296_tec.c"
...
# 13 "../../other/sgm41296_TEC/sgm41296_tec.c" 2
...
# 14 "../../other/sgm41296_TEC/sgm41296_tec.c" 2
# 1 "../../other/sgm41296_TEC/sgm41296_tec.h" 1
# 16 "../../other/sgm41296_TEC/sgm41296_tec.h"
...
# 17 "../../other/sgm41296_TEC/sgm41296_tec.h" 2
# 1 "../../include\\user_config.h" 1
# 18 "../../other/sgm41296_TEC/sgm41296_tec.h" 2
...
# 15 "../../other/sgm41296_TEC/sgm41296_tec.c" 2
# 1 "../../mcu\\mcu_pin_type.h" 1
# 16 "../../other/sgm41296_TEC/sgm41296_tec.c" 2
...
# 19 "../../other/sgm41296_TEC/sgm41296_tec.c" 2
# 38 "../../other/sgm41296_TEC/sgm41296_tec.c"
void sgm41296_tec_gpio_init()
{

 gpio_mode_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000800U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)),((uint32_t)((uint32_t)0x01U<<(6))));
    gpio_output_options_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000800U), ((uint8_t)(0x00U)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(3) << 0)),((uint32_t)((uint32_t)0x01U<<(6))));
 gpio_bit_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000800U),((uint32_t)((uint32_t)0x01U<<(6))));


 gpio_mode_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000800U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)),((uint32_t)((uint32_t)0x01U<<(7))));
    gpio_output_options_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000800U), ((uint8_t)(0x00U)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(3) << 0)),((uint32_t)((uint32_t)0x01U<<(7))));
 gpio_bit_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000800U),((uint32_t)((uint32_t)0x01U<<(7))));

 return;
}
# 65 "../../other/sgm41296_TEC/sgm41296_tec.c"
void sgm41296_tec_get_xtec_voltage(float *voltage)
{
 uint16_t data = 0;
 ...
 data = adc_dma_channel_sample_average(((uint8_t)0x0AU));
 *voltage = 2.5 / 4096 * data;

 return;
}
# 93 "../../other/sgm41296_TEC/sgm41296_tec.c"
uint32_t sgm41296_tec_get_therm_adc()
{
 return adc_dma_channel_sample_average(((uint8_t)0x0BU));

}
# 112 "../../other/sgm41296_TEC/sgm41296_tec.c"
void sgm41296_tec_release_limit_refresh()
{
...
# 156 "../../other/sgm41296_TEC/sgm41296_tec.c"
void sgm1296_tec_init(void)
{
 sgm41296_vtec_dac_ctl_set(1.25);
 sgm41296_tec_gpio_init();
}
# 177 "../../other/sgm41296_TEC/sgm41296_tec.c"
void sgm41296_vtec_dac_ctl_set(float voltage)
{
 uint16_t data = 0;
 data = voltage * 4096 / 2.5;
 dac_data_set((((uint32_t)0x40000000U) + 0x0000CC00U), ((uint8_t)0x00U),(((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)),data);
