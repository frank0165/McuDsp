# 1 "../../mcu/dac_comm/dac_comm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../mcu/dac_comm/dac_comm.c" 2
# 12 "../../mcu/dac_comm/dac_comm.c"
...
# 13 "../../mcu/dac_comm/dac_comm.c" 2
# 1 "../../mcu/dac_comm/dac_comm.h" 1
# 34 "../../mcu/dac_comm/dac_comm.h"
void dac_config_init(void);
# 14 "../../mcu/dac_comm/dac_comm.c" 2
# 1 "../../mcu/dac_comm/dac_driver.h" 1
# 28 "../../mcu/dac_comm/dac_driver.h"
void dac_gpion_init();
# 43 "../../mcu/dac_comm/dac_driver.h"
void dac_periph_config(void);
# 15 "../../mcu/dac_comm/dac_comm.c" 2
# 30 "../../mcu/dac_comm/dac_comm.c"
void dac_config_init(void)
{
 dac_gpion_init();
    dac_periph_config();
