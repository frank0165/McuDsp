# 1 "../../mcu/GDE501_fireware/gd32e501_it.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../mcu/GDE501_fireware/gd32e501_it.c" 2
# 36 "../../mcu/GDE501_fireware/gd32e501_it.c"
...
# 37 "../../mcu/GDE501_fireware/gd32e501_it.c" 2
...
# 38 "../../mcu/GDE501_fireware/gd32e501_it.c" 2
...
# 39 "../../mcu/GDE501_fireware/gd32e501_it.c" 2
...
extern void i2c_slave_func_register_write_callback(uint32_t
   slave_address,I2C_WRITE_CFG_CALLBACK write_callback);
# 40 "../../mcu/GDE501_fireware/gd32e501_it.c" 2
# 1 "../../mcu\\timer_comm.h" 1
# 46 "../../mcu\\timer_comm.h"
void timer_process_init(void);
# 41 "../../mcu/GDE501_fireware/gd32e501_it.c" 2
# 1 "../../other\\trigger_interrupt_mode.h" 1
# 37 "../../other\\trigger_interrupt_mode.h"
void mcu_trigger_mode_init();
# 42 "../../mcu/GDE501_fireware/gd32e501_it.c" 2
# 62 "../../mcu/GDE501_fireware/gd32e501_it.c"
...
{
   master_i2c_event_irq_handler(((((uint32_t)0x40000000U) + 0x00005400U)+0x00000400U));
}
...
{
   master_i2c_error_irq_handler(((((uint32_t)0x40000000U) + 0x00005400U)+0x00000400U));
}

void I2C0_EV_IRQHandler(void)
{
   master_i2c_event_irq_handler((((uint32_t)0x40000000U) + 0x00005400U));
}
...
{
   master_i2c_error_irq_handler((((uint32_t)0x40000000U) + 0x00005400U));
}
...
{
 slave_event_irq_handler(((((uint32_t)0x40000000U) + 0x00005400U)+0x00006C00U));
}
...
# 205 "../../mcu/GDE501_fireware/gd32e501_it.c"
void SysTick_Handler(void)
{
...
# 224 "../../mcu/GDE501_fireware/gd32e501_it.c"
...
volatile uint8_t g_usart_txcount = 0;
volatile uint16_t g_usart_rxcount = 0;
# 260 "../../mcu/GDE501_fireware/gd32e501_it.c"
void USART0_IRQHandler(void)
{
    if(RESET != usart_interrupt_flag_get(((((uint32_t)0x40000000U) + 0x00004400U) + 0x0000F400U), USART_INT_FLAG_RBNE)){

        g_usart_receiver_buffer[g_usart_rxcount++] = usart_data_receive(((((uint32_t)0x40000000U) + 0x00004400U) + 0x0000F400U));
        if(g_usart_rxcount == g_usart_receivesize){
            usart_interrupt_disable(((((uint32_t)0x40000000U) + 0x00004400U) + 0x0000F400U), USART_INT_RBNE);
        }
    }

    if(RESET != usart_interrupt_flag_get(((((uint32_t)0x40000000U) + 0x00004400U) + 0x0000F400U), USART_INT_FLAG_TBE)){

        usart_data_transmit(((((uint32_t)0x40000000U) + 0x00004400U) + 0x0000F400U), g_usart_receiver_buffer[g_usart_rxcount++]);
        if(g_usart_rxcount == g_usart_receivesize){
