# 1 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_wwdgt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_wwdgt.c" 2
# 36 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_wwdgt.c"
...
# 37 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_wwdgt.c" 2
# 49 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_wwdgt.c"
void wwdgt_deinit(void)
{
...
void wwdgt_counter_update(uint16_t counter_value)
{
    ...
    reg = (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00002C00U)) + 0x00000000U)) & (~(uint32_t)((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(6)))));
    reg |= (uint32_t)((((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(6)))) & ((uint32_t)(counter_value) << 0U)));

    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00002C00U)) + 0x00000000U)) = (uint32_t)reg;
}
# 95 "../../mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_wwdgt.c"
void wwdgt_config(uint16_t counter, uint16_t window, uint32_t prescaler)
{
    uint32_t reg_cfg = 0x00000000U, reg_ctl = 0x00000000U;


    reg_cfg = (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00002C00U)) + 0x00000004U)) & (~((uint32_t)((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(6)))) | (uint32_t)((0xFFFFFFFFUL << (7)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(8))))));
    reg_ctl = (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00002C00U)) + 0x00000000U)) & (~(uint32_t)((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(6)))));


    reg_cfg |= (uint32_t)((((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(6)))) & ((uint32_t)(window) << 0U)));
    reg_cfg |= (uint32_t)(prescaler);
    reg_ctl |= (uint32_t)((((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(6)))) & ((uint32_t)(counter) << 0U)));

    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00002C00U)) + 0x00000004U)) = (uint32_t)reg_cfg;
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00002C00U)) + 0x00000000U)) = (uint32_t)reg_ctl;
}
