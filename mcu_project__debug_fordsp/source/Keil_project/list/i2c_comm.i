# 1 "../../mcu/i2c_comm/i2c_comm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../mcu/i2c_comm/i2c_comm.c" 2
...
# 5 "../../mcu/i2c_comm/i2c_comm.c" 2
# 1 "../../mcu/i2c_comm/i2c_driver.h" 1
# 30 "../../mcu/i2c_comm/i2c_driver.h"
void gpio_slave_i2c_config_init(void);
# 45 "../../mcu/i2c_comm/i2c_driver.h"
void gpio_master_i2c_config_init(void);
# 6 "../../mcu/i2c_comm/i2c_comm.c" 2
...
MCU_REGADDR_WRITE_CALLBACK_HANDLE
g_mcu_addr0xspec_reg_write_callback_array[(44)];
...
MCU_REGADDR_READ_CALLBACK_HANDLE
g_mcu_addr0xspec_reg_read_callback_array[(44)];
    ...
    MCU_REGADDR_WRITE_CALLBACK write_callback)
{
 ...
 if(g_mcu_addr0xspec_reg_write_idx < (44))
 {
   ...
   MCU_REGADDR_READ_CALLBACK read_callback)
{
 ...
 if(g_mcu_addr0xspec_reg_read_idx < (44))
 {
