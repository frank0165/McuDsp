# 1 "../../thermistor_rth/thermistor_rth.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../thermistor_rth/thermistor_rth.c" 2
...
# 3 "../../thermistor_rth/thermistor_rth.c" 2
...
# 6 "../../thermistor_rth/thermistor_rth.c" 2
...
# 7 "../../thermistor_rth/thermistor_rth.c" 2
# 1 "../../thermistor_rth/thermistor_rth.h" 1
# 37 "../../thermistor_rth/thermistor_rth.h"
void get_tec_therm_temperature(float *temp);
# 51 "../../thermistor_rth/thermistor_rth.h"
void get_case_therm_temperature(float *temp);
# 8 "../../thermistor_rth/thermistor_rth.c" 2
...
# 9 "../../thermistor_rth/thermistor_rth.c" 2
...
# 10 "../../thermistor_rth/thermistor_rth.c" 2
...
# 13 "../../thermistor_rth/thermistor_rth.c" 2
# 26 "../../thermistor_rth/thermistor_rth.c"
...
# 202 "../../thermistor_rth/thermistor_rth.c"
...
# 256 "../../thermistor_rth/thermistor_rth.c"
 ...
 uint32_t* temp)
{
 ...
 if (0 == tec_table || tec_count < 1 || 0 == temp)
 {
  return;
 }
 ...
 {
  *temp = leftn * 100 +
   (*(tec_table + leftn) - adc_value) * 100 / (*(tec_table +
   leftn) - *(tec_table + rightn));
 }

}
# 306 "../../thermistor_rth/thermistor_rth.c"
...
# 393 "../../thermistor_rth/thermistor_rth.c"
void get_tec_therm_temperature(float *temp)
{
 float vtherm = 0.0;
 uint32_t value = 0;
...
# 432 "../../thermistor_rth/thermistor_rth.c"
void get_case_therm_temperature(float *temp)
{
 float vtherm = 0.0;
 uint32_t value = 0;
 ...
 adc_value = adc_dma_channel_sample_average(((uint8_t)0x04U));
